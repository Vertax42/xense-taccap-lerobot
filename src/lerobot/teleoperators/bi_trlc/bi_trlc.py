...
class BiTRLC(Teleoperator):
    ...
    def is_calibrated(self) -> bool:
        return self._left_joint_offsets is not None and self._right_joint_offsets is not None
    ...
    def configure(self) -> None:
        ...
        for side, bus, cfg_open in [
            ...
            bus.write("Operating_Mode", "gripper", OperatingMode.CURRENT_POSITION.value, normalize=False)
    ...
    def get_action(self) -> dict[str, float]:
        ...
        left_raw = self.left_bus.sync_read(normalize=False, data_name="Present_Position", num_retry=2)
